...
### 3.5 Delete Document
Deletes a document from the PostgreSQL database and removes its underlying file object from S3 storage.
...
| **Documents** | `DELETE`| `/documents/:id` | 🔓 Optional Auth | Delete document from PostgreSQL & S3 |
